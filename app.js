...
// ** SECTION
// From array cardio day 2 of javascript30
...
const isGreaterThanNineteen = number => number > 19
const getBirthYear = obj => obj.year
const getAge = birthYear => new Date().getFullYear() - birthYear

const getPeopleAge = array => array.map(getBirthYear).map(getAge)

// Array.prototype.some()
// is at least one person 19 or older?
const someOlderThanNineteen = array =>
  getPeopleAge(array).some(isGreaterThanNineteen)

// Array.prototype.every()
// is everyone 19 or older?
const everyOlderThanNineteen = array =>
  getPeopleAge(array).every(isGreaterThanNineteen)
...
const getIndexByIdAndDelete = (array, id) => {
  const index = array.findIndex(item => item.id === id)
  // this is not a good practice, because it will modify the original array
  // return array.splice(index, 1)
  // instead we can create a new array and return it without touching the original array
